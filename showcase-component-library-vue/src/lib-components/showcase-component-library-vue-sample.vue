...
export default /*#__PURE__*/defineComponent({
  name: 'ShowcaseComponentLibraryVueSample', // vue component name
  data(): SampleData {
    return {
      counter: 5,
      initCounter: 5,
...
<template>
  <div class="showcase-component-library-vue-sample">
...
<style scoped>
  .showcase-component-library-vue-sample {
    display: block;
    width: 400px;
    margin: 25px auto;
  ...
  .showcase-component-library-vue-sample p {
    margin: 0 0 1em;
  }
</style>
